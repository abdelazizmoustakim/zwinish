        ...
        <div className="relative z-10 min-h-screen px-4 py-8">
          ...
          >
            ...
            <div className="lg:hidden">
              {/* Mobile Profile Card */}
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6 mb-6">
                {/* Profile Header */}
            ...
            <div className="hidden lg:flex gap-8">
              ...
              <div className="w-80 flex-shrink-0">
                <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6 sticky top-8">
                  {/* Profile Header */}
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-lg font-bold text-gray-800 mb-1">{user.name || 'User'}</h2>
                    <p className="text-sm text-gray-600">{user.email}</p>
                  </div>
