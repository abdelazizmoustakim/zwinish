    ...
    <section className="bg-white text-gray-900">
      <div className="container mx-auto flex flex-col items-center px-4 py-20 text-center max-w-3xl">
        <h1 className="text-5xl font-extrabold leading-tight sm:text-6xl">
          Welcome to <span className="text-violet-600">Zwinish</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center mt-10">
          <Link href="/Posts" className="px-8 py-3 m-2 text-lg font-semibold rounded bg-violet-600 text-white hover:bg-violet-700 transition">
              Explore Blogs
          </Link>
